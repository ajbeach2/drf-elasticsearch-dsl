...
which supports all of the field types provided by `elastic-search-dsl persistence`_., and is losely based of of the ``DocType`` class provided by ``elasticsearch-dsl.py``
